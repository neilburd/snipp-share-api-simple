...
class SnippetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post snippets_url, params: { snippet: { code: @snippet.code, language: @snippet.language, title: @snippet.title } }, as: :json
    end
  ...
  test "should update snippet" do
    patch snippet_url(@snippet), params: { snippet: { code: @snippet.code, language: @snippet.language, title: @snippet.title } }, as: :json
    assert_response 200
  end
